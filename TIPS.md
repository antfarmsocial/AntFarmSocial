# Ant Farm Social Tips

You found the tips file!

The game is designed without any instructions, as most of it can be worked out through experimentation.
...
- Some items never drop if you have only 1 farm, and some never drop if you have only 2 farms.  If you don't need
  anything, it is best to save your Nerd Boxes for when you have 3 farms.
- Removing food/drink will encourage ants to seek a tube or vial, but is not guaranteed, so must still be monitored
  for very low stats.
