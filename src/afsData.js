...
kudos = [
  ...
  [
    ["Ain't nobody farm ants 🐜 like you"],
    ["Way to go hot shot 🔥🎯🔥"],
    ["You can DO IT! 🤗"],
    ["🎸You're a ROCK STAR ⚡🤟⚡"],
  ...
  [
    ...
    ["Oh, another point. Your life must be so exciting."],
    ["You managed to score a point. How impressive."],
    ["One more? Seriously?"],
    ...
    ["Another one? Yawn."],
    ["Oh look, another point. How amazing."],
    ["Another point? Groundbreaking."],
    ["Wow, you have another. Should we celebrate?"],
...
jokes = [
  ...
  [
    ...
    ['How does the concept of "self" apply to an ant', "and what does this reveal about the nature of individual identity?"],
